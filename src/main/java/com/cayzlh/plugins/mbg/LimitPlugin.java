...
public class LimitPlugin extends BasePlugin {
    ...
    public boolean modelExampleClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        logger.debug("(MySQL分页插件):"+topLevelClass.getType().getShortName()+"增加offset和rows字段");
        ...
        logger.debug("(MySQL分页插件):"+topLevelClass.getType().getShortName()+"增加offset和rows的getter和setter实现。");
        ...
        logger.debug("(MySQL分页插件):"+topLevelClass.getType().getShortName()+"增加limit方法。");
    ...
    public void generateLimitElement(XmlElement element, IntrospectedTable introspectedTable){
        ...
        logger.debug("(MySQL分页插件):"+introspectedTable.getMyBatis3XmlMapperFileName()+"selectByExample方法增加分页条件。");
    }
}
